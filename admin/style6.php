...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '| heading-font-color |#ffffff|'
            . ' heading-background-color |#9e9e9e| heading-font-active-color |#ffffff|'
            . ' heading-background-active-color |#0090a6| heading-font-familly |arial|'
            . ' heading-font-weight |' . sanitize_text_field($_POST['heading-font-weight']) . '| heading-padding-up-bottom |' . sanitize_text_field($_POST['heading-padding-top-bottom']) . '| heading-padding-left-right |' . sanitize_text_field($_POST['heading-padding-left-right']) . '|'
            . ' content-font-size |' . sanitize_text_field($_POST['content-font-size']) . '| content-font-color |#696969| content-background-color |#dbdbdb| content-padding-top |' . sanitize_text_field($_POST['content-padding-top']) . '|'
            ...
            . ' content-padding-left |' . sanitize_text_field($_POST['content-padding-left']) . '| content-width |' . sanitize_text_field($_POST['content-width']) . '| content-line-height |' . sanitize_text_field($_POST['content-line-height']) . '|'
            . ' content-font-familly |arial| content-font-weight |' . sanitize_text_field($_POST['content-font-weight']) . '| content-font-align |' . sanitize_text_field($_POST['content-font-align']) . '| content-box-shadow |0| content-box-shadow-color |#fff|  |';
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery("#heading-padding-top-bottom").on("change", function () {
                var idvalue = jQuery('#heading-padding-top-bottom').val() + 'px';
                jQuery("<style type='text/css'> .ctu-edit-heading li{ padding-top: " + idvalue + ";} </style>").appendTo(".ctu-edit-heading");
                jQuery("<style type='text/css'> .ctu-edit-heading li{ padding-bottom: " + idvalue + ";} </style>").appendTo(".ctu-edit-heading");
            });
            jQuery("#heading-padding-left-right").on("change", function () {
                var idvalue = jQuery('#heading-padding-left-right').val() + 'px';
                jQuery("<style type='text/css'> .ctu-edit-heading li{ padding-left: " + idvalue + " ;} </style>").appendTo(".ctu-edit-heading");
                jQuery("<style type='text/css'> .ctu-edit-heading li{ padding-right: " + idvalue + " ;} </style>").appendTo(".ctu-edit-heading");
            });
            ...
            jQuery("#content-background-color").on("change", function () {
                ...
                jQuery("<style type='text/css'> .ctu-ultimate-wrapper{ background-color:" + idvalue + ";} </style>").appendTo(".ctu-edit-heading");
            });
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row form-group-sm">
                            ...
                            <div class="col-sm-6 nopadding">
                                <input type="text" class="form-control ctu-vendor-color" id="content-font-color" name="content-font-color" value="<?php echo $styledata[21]; ?>">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                            ...
                            <div class="col-sm-6 nopadding">
                                <input type="text" class="form-control ctu-vendor-color" id="content-background-color" name="content-background-color" value="<?php echo $styledata[23]; ?>">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                        ...
                        <div class="form-group row form-group-sm">
                            <label for="content-width" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Customize Your Content and title Box width Based on Full width Percentage ">Width </label>
                            <div class="col-sm-6 nopadding">
                                <input class="form-control" type="number" min="10" max="90" value="<?php echo $styledata[33]; ?>" id="content-width" name="content-width">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
