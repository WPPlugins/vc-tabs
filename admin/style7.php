...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '| heading-font-color |#ffffff|'
            . ' heading-background-color |#1bd1db| heading-font-active-color |#ffffff|'
            . ' heading-background-active-color |#00ad7f| heading-border-color |#d9d9d9|'
            . ' heading-font-familly |arial| heading-font-weight |' . sanitize_text_field($_POST['heading-font-weight']) . '| heading-width |' . sanitize_text_field($_POST['heading-width']) . '|'
            ...
            . ' content-font-size |' . sanitize_text_field($_POST['content-font-size']) . '| content-font-color |#636363| content-background-color |#f7f7f7|'
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery("#content-border-color").on("change", function () {
                ...
                jQuery("<style type='text/css'> .ctu-ultimate-wrapper{ border-color:" + idvalue + ";} </style>").appendTo(".ctu-edit-heading");
            });
            jQuery("#content-border-radius").on("change", function () {
                var idvalue = jQuery('#content-border-radius').val();
                jQuery("<style type='text/css'> .ctu-ultimate-wrapper{ border-radius:" + idvalue + "px " + idvalue + "px 0 0 ;} </style>").appendTo(".ctu-edit-heading");
            });
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row form-group-sm">
                            <label for="heading-border-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Customize Your Heading Border Color, Based on Color">Border <a class="ctu-pro-only">Pro Only</a></label>
                            <div class="col-sm-6 nopadding">
                                <input type="text" class="form-control ctu-vendor-color" id="heading-border-color" name="heading-border-color" value="<?php echo$styledata[11]; ?>">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row form-group-sm">
                            ...
                            <div class="col-sm-6 nopadding">
                                <input type="text" class="form-control ctu-vendor-color" id="content-font-color" name="content-font-color" value="<?php echo $styledata[25]; ?>">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                            ...
                            <div class="col-sm-6 nopadding">
                                <input type="text" class="form-control ctu-vendor-color" id="content-background-color" name="content-background-color" value="<?php echo $styledata[27]; ?>">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                        ...
                        <div class="form-group row form-group-sm">
                            ...
                            <div class="col-sm-6 nopadding">
                                <input class="cau-admin-font" value="<?php echo $styledata[39]; ?>" type="text" name="content-font-familly" id="content-font-familly">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                        ...
                        <div class="form-group row form-group-sm">
                            <label for="content-border-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Add custom color to Border Color">Border Color  <a class="ctu-pro-only">Pro Only</a></label>
                            <div class="col-sm-6 nopadding">
                                <input type="text" class="form-control ctu-vendor-color" id="content-border-color" name="content-border-color" value="<?php echo $styledata[45]; ?>">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                            <label for="content-border-radius" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Attach Shadow Size to Content Box, Based on Pixel">Border Radius  <a class="ctu-pro-only">Pro Only</a></label>
                            <div class="col-sm-6 nopadding">
                                <input class="form-control" type="number" value="<?php echo $styledata[51]; ?>" id="content-border-radius" name="content-border-radius">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                            <label for="content-box-shadow" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Add custom Shadow Color to Content Box">Box Shadow  <a class="ctu-pro-only">Pro Only</a></label>
                            <div class="col-sm-6 nopadding">
                                <input class="form-control" type="number" value="<?php echo $styledata[47]; ?>" id="content-box-shadow" name="content-box-shadow">
                            </div>
                        </div>
                        <div class="form-group row form-group-sm">
                            ...
                            <div class="col-sm-6 nopadding">
                                <input type="text" class="form-control ctu-vendor-color" id="content-box-shadow-color" name="content-box-shadow-color" value="<?php echo $styledata[49]; ?>">
                            </div>
                        </div>
