...
if (!empty($_POST['edit']) && is_numeric($_POST['item-id'])) {
    ...
    $title = ctu_admin_special_charecter($data['title']);
...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '| heading-font-color |#545454| heading-background-color |#ffffff| heading-font-active-color |#ffffff| heading-background-active-color |#6dc5db| heading-font-familly |arial| heading-font-weight |' . sanitize_text_field($_POST['heading-font-weight']) . '| heading-text-align |flex-start| heading-width |' . sanitize_text_field($_POST['heading-width']) . '| heading-padding |' . sanitize_text_field($_POST['heading-padding']) . '| heading-Border-radius |0| heading-box-shadow |0| heading-box-shadow-color |#fff| content-font-size |' . sanitize_text_field($_POST['content-font-size']) . '| content-font-color |#524f4f| content-background-color |#ffffff| content-padding-top |' . sanitize_text_field($_POST['content-padding-top']) . '| content-padding-right |' . sanitize_text_field($_POST['content-padding-right']) . '| content-padding-bottom |' . sanitize_text_field($_POST['content-padding-bottom']) . '| content-padding-left |' . sanitize_text_field($_POST['content-padding-left']) . '| content-line-height |' . sanitize_text_field($_POST['content-line-height']) . '| content-font-familly |arial| content-font-weight |' . sanitize_text_field($_POST['content-font-weight']) . '| content-font-align |' . sanitize_text_field($_POST['content-font-align']) . '| content-box-shadow |0| content-box-shadow-color |#fff| heading-margin-top |0| heading-margin-bottom |' . sanitize_text_field($_POST['heading-margin-bottom']) . '||';
            ...
            <div class="ctu-admin-style-left-template">
                <style>
                    ...
                    .ctu-ulimate-style-<?php echo $styleid; ?> li{
                        ...
                        float: left;
                        font-family: "<?php echo str_replace("+", " ", $styledata[11]); ?>";
                    ...
                    .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{
                        ...
                        display: none;
                        font-family: "<?php echo str_replace("+", " ", $styledata[43]); ?>";
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery("#heading-box-shadow").on("change", function () {
                ...
                jQuery("<style type='text/css'> .ctu-edit-heading { box-shadow:" + idvalue + ";} </style>").appendTo(".ctu-edit-heading");
            });
            ...
            jQuery("#content-box-shadow").on("change", function () {
                ...
                jQuery("<style type='text/css'> .ctu-edit-content{box-shadow:" + idvalue + ";} </style>").appendTo(".ctu-edit-content");
            });
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row form-group-sm">
                            <label for="heading-background-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Title background Color, Based on Color">Background  <a class="ctu-pro-only">Pro Only</a></label>
                            <div class="col-sm-6 nopadding">
                        ...
                        <div class="form-group row form-group-sm">
                            <label for="heading-font-active-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Yout Active Title Font Color, Based on Color">Color Active <a class="ctu-pro-only">Pro Only</a></label>
                            <div class="col-sm-6 nopadding">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row form-group-sm">
                            <label for="content-box-shadow-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Add custom Shadow Collor to Content Box">Box Shadow Color <a class="ctu-pro-only">Pro Only</a></label>
                            <div class="col-sm-6 nopadding">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4" id="ctu-details" name="ctu-details"><?php echo $files ?></textarea>
